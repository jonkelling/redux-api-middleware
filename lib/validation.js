...
function isRSAA(action) {
  return (0, _lodashIsplainobject2['default'])(action) && action.hasOwnProperty(_CALL_API2['default']);
}
...
function isValidTypeDescriptor(obj) {
  ...
  if (!(0, _lodashIsplainobject2['default'])(obj)) {
    return false;
  }
  for (var key in obj) {
...
function validateRSAA(action) {
  ...
  if (!(0, _lodashIsplainobject2['default'])(callAPI)) {
  ...
  if (typeof headers !== 'undefined' && !(0, _lodashIsplainobject2['default'])(headers) && typeof headers !== 'function') {
